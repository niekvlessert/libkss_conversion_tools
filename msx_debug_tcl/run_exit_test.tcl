# Verify that Escape exits the complete-page player and restores DOS2.
...
set PSG_volume 100
set SCC_volume 100
after realtime 20 {type "KSPPLAY.COM SALAMAND.KSP 5"}
after realtime 23 {type "\r"}
after realtime 32 {keymatrixdown 7 0x04}
after realtime 33 {keymatrixup 7 0x04}
after realtime 39 {
    set state [open [file join $test_dir salamander-exit-state.txt] w]
