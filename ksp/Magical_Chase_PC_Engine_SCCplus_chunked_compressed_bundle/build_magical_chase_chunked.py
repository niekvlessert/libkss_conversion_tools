...
OUTDIR=Path('/mnt/data/magical_chase_sccplus_ksp')
...
def main():
    ...
    out=OUTDIR/'Magical_Chase_PC_Engine_SCCplus_chunked_prototype.ksp'
    ...
    info={
        ...
        'source_hes_sha256':hashlib.sha256(Path('/mnt/data/magical_chase_hes/PL91001.hes').read_bytes()).hexdigest(),
    ...
    (OUTDIR/'Magical_Chase_PC_Engine_SCCplus_chunked_prototype.json').write_text(json.dumps(info,indent=2,ensure_ascii=False))
    ...
    zip_path=OUTDIR/'Magical_Chase_PC_Engine_SCCplus_chunked_prototype_bundle.zip'
