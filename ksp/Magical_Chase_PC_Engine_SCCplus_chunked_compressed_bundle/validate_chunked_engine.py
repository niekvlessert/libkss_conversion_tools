...
import struct,json
BASE=Path('/mnt/data/magical_chase_sccplus_ksp')
KSP=(BASE/'Magical_Chase_PC_Engine_SCCplus_chunked_prototype.ksp').read_bytes()
...
for i in range(track_count):
 full=(Path('/mnt/data/magical_chase_ksp_build')/f'{i:02d}.bin').read_bytes()
